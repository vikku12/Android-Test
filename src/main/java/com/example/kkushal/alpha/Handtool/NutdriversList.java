...
public class NutdriversList extends ListFragment {



    // Array of strings storing country names
    String[] CBtitle_name1 = new String[]{"Eastman Tubular Box Spanner","Freemans Lock Measuring Tape","Gedore Cranked Socket Key","Stanley 6Pc","NutDriver 234"
    };
    ...
    int[] CBicon_img1 = new int[]{R.drawable.sw6,R.drawable.sw7,R.drawable.sn1,R.drawable.sn2,R.drawable.sn3};
