...
public class ScrewdriversList extends ListFragment {



    // Array of strings storing country names
    String[] CBtitle_name1 = new String[]{"Ajay Spares For Chain Pipe Wrench","Ajay 4-Way Wheel Spanner A-122","BAUM Tool Box ART-B-16","Eastman Combination Heavy Duty \",\n" +
            "Eastman Double Open Ended Heavy"
    };
    ...
    int[] CBicon_img1 = new int[]{ R.drawable.sw1,R.drawable.sw2,R.drawable.sw3,R.drawable.sw4,R.drawable.sw5};
