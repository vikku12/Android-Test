...
public class DeviceFragmentHandtool extends Fragment {
    ...
    public class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private final String[] TITLES = { "SCREWDRIVERS","NUTDRIVERS","SPANNERS","WRENCHES"};
        ...
        public Fragment getItem(int arg0) {
            ...
            switch (arg0) {
                ...
                case 0:
                    return new ScrewdriversList();

                case 1:
                    return new NutdriversList();

                case 2:
                    return new SpannersList();
                case 3:
                    return new WrenchesList();
